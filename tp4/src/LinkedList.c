...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    {
        pNode= this->pFirstNode; //por default accedo al primer vagon

        for(int i=0;i<nodeIndex;i++) //me desplazo de vagon en vagon para finalmente acceder al nodo anterior del indice solicitado, accediendo a este ultimo mediante el pNextNode
        {
...
*/
//crea vagon, lo llena y lo inserta en el tren ahre
static int addNode(LinkedList* this, int nodeIndex, void* pElement)
{
    int returnAux = -1;
    Node *newNode = NULL;
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex<=ll_len(this))
    {
        ...
        if(newNode != NULL)
        {
            ...
            if(nodeIndex == 0)
            {
                newNode->pNextNode = this->pFirstNode; //engancho el vagon que estaba antes en i0 para no perderlo
                this->pFirstNode = newNode;
            }else
            {
                newNode->pNextNode = getNode(this, nodeIndex); //idem
                prevNode = getNode(this, nodeIndex-1);
                prevNode->pNextNode = newNode;
            }
            this->size++;
...
/** \brief  Agrega un elemento a la lista, sin especificar la ubicacion, osea lo agrega al final
 ...
 */int ll_add(LinkedList* this, void* pElement)
{
    ...
    {
        len = ll_len(this);
        addNode(this, len, pElement); //añado nodo al final
        returnAux = 0;
    }
    return returnAux;
}
 ...
 *
 */
//Devuelve lo que esta dentro del nodo,osea,devuelve el puntero a algun tipo de entidad. Usa el getnode para obtener
//el nodo
...
{
    int returnAux= addNode(this, index, pElement);
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
	...
	if(this != NULL && this2 != NULL)
	{
		...
		for(i=0; i<len2; i++)
		{
			...
			if(!ll_contains(this, auxElement)) //si la segunda lista contiene el elemento
			{
				returnAux = 0;
				break;
			}
